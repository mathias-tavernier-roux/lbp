                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">MODE ADMINISTRATEUR</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow" style="margin-bottom: 10px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Modérateurs</p>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card shadow" style="margin-bottom: 10px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Boutiques Professionnel</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
