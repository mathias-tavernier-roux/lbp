        ...
        <section class="boutique_par">
            ...
            <section class="description_container">
                <section class="description_boutique_par">
                    ...
                    <div class="modifier"><a class="btn btn-info text_white col-12" href="<?= ACCUEIL ?>annoncemodifier/pro/<?= $annonce->id ?>/<?= $boutique->id ?>">Modifier mon annonce</a></div>
                ...
                <section class="boutique_boutique_par">
                    ...
                    <div class="voir_boutique"><a class="btn btn-primary col-12" href="<?= ACCUEIL ?>boutiqueaccueil/accueilpro">Retour à la boutique</a></div>
                </section>
            </section>
        </section>
    </section>
