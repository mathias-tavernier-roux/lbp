        ...
        <section class="boutique_par">
            ...
            <section class="description_container">
                <section class="description_boutique_par">
                    ...
                    <?php $_SESSION['Vendeur'] = $boutique->nom_boutique ?>
                    ...
                    <?php $_SESSION['Livraison'] = $livraison->prix ?>
                    <div class="livraison">
                    ...
                    $STOCK = 0;
                    if (isset($_SESSION['user']['droit']) and $annonce->stock != 0 and $_SESSION['user']['droit'] == 1) { ?>
                    ...
                    <?php }
                    if (isset($_SESSION['user']['droit']) and $annonce->stock != 0 and $_SESSION['user']['droit'] == 10) { ?>
                        <form method="POST" action="<?= ACCUEIL ?>panier/add">
                            <select name=Quantité id=Quantité>
                                <?php
                                while ($STOCK < $STOCK_MAX) {
                ...
                <section class="boutique_boutique_par">
                    ...
                    <div class="voir_boutique"><a class="btn btn-primary col-12" href="<?= ACCUEIL ?>boutiqueaccueil/par/<?= $boutique->id ?>">Visiter</a></div>
                </section>
            </section>
        </section>
    </section>
