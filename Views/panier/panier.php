<section class="panier_page">
    <section class="panier_tab">
        <h1>Mon panier</h1>
        <p><i>Certains articles Stockés peuvent avoir été modifiés voir cachés si le stock des articles concernés a changé ou si les articles concernés ont été modifiés / effacés</i></p>
        <?php
        $panier_total = 0;
